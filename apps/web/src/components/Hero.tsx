...
export const Hero: React.FC = () => {
  ...
  return (
    <header className="relative w-full pt-12 md:pt-20 pb-16 px-6 sm:px-12 md:px-16 overflow-hidden">
      {/* Deep atmospheric ambient glow */}
      <div className="absolute top-1/3 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[500px] bg-cyan-900/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute top-1/2 right-1/4 w-[500px] h-[400px] bg-blue-900/10 rounded-full blur-[100px] pointer-events-none" />

      <div className="max-w-[1500px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-start">
        {/* Left Column: Editorial Content */}
        <div className="lg:col-span-7 space-y-8 flex flex-col justify-between z-10">
          <div className="space-y-6">
            {/* Eyebrow */}
            <div className="inline-flex items-center gap-2 font-mono text-xs sm:text-sm tracking-[0.2em] text-zinc-400 border border-white/10 px-3 py-1 bg-white/[0.03]">
              <span className="w-2 h-2 rounded-full bg-cyan-400 animate-pulse" />
              <span>Open Source • MIT License</span>
            </div>

            {/* Giant Serif Display Headline */}
            <h1 className="font-serif-display text-5xl sm:text-7xl md:text-8xl xl:text-[6.2rem] font-light leading-[0.9] tracking-[0.01em] text-white">
              <span className="block font-light text-zinc-100">The CLI</span>
              <span className="block font-normal text-transparent bg-clip-text bg-gradient-to-r from-white via-zinc-200 to-cyan-200">
                That Scaffolds
              </span>
            ...
            {/* Monospace Subtitle */}
            <p className="font-mono text-xs sm:text-sm md:text-base text-zinc-400 max-w-2xl leading-[1.7]">
          ...
          <div className="space-y-6 pt-2 max-w-xl">
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <button
                  ...
                  className="group bg-[#f5f5f0] text-[#08090e] inline-flex items-center gap-3 px-6 py-3.5 shadow-[0_4px_20px_rgba(0,0,0,0.6)] hover:bg-[#00f0ff] hover:text-[#08090e] transition-all font-mono text-xs sm:text-sm font-bold tracking-wider cursor-pointer"
                >
                  {copiedBtn ? <Check className="w-4 h-4 text-emerald-600" /> : <Terminal className="w-4 h-4 transition-transform group-hover:scale-110" />}
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between font-mono text-xs tracking-[0.14em] text-zinc-400">
              ...
              <div className="flex items-center justify-between bg-[#0e1017] border border-white/15 p-3 sm:p-4 shadow-[0_4px_20px_rgba(0,0,0,0.5)]">
          ...
          {/* Quick Metrics Line */}
          <div className="pt-4 flex flex-wrap items-center gap-6 font-mono text-xs text-zinc-500 border-t border-white/10">
