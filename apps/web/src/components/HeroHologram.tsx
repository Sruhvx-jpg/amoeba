  ...
  return (
    <div className="relative select-none flex flex-col items-center justify-center">
      ...
      <div className="w-full border border-white/15 bg-[#0e1017] p-6 md:p-7 shadow-[0_8px_30px_rgba(0,0,0,0.6)] overflow-hidden">
        ...
        {/* Static, Crisp ASCII Rendering */}
        <pre className="font-mono text-[9px] xs:text-[11px] sm:text-[12px] md:text-[13px] leading-tight text-cyan-300 font-bold text-center tracking-widest overflow-x-auto whitespace-pre">
          {SCULPTURE}
        </pre>

        {/* Bottom Banner */}
        <div className="mt-4 pt-2.5 border-t border-white/10 flex items-center justify-between font-mono text-[10px] text-zinc-500">
          <span>MEMBRANE: <strong className="text-emerald-400">NOMINAL</strong></span>
